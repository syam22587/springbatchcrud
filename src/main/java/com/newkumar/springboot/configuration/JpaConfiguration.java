package com.newkumar.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.newkumar.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.newkumar.springboot.model" });
